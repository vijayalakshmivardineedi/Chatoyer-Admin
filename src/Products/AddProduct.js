...
const CreateProduct = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axiosInstance.post("/createProduct", updatedFormData, {
                headers: {
        ...
        <div className='Addproducts-container'>
            <div className='Addproducts-header'>
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    ...
                    <h2 className='Addproducts-header-text'>Create Product</h2>
                </div>
            </div>
            <form onSubmit={handleSubmit} style={{ display: 'flex', width: '100%' }}>
                <div style={{ flex: 1, marginRight: '20px' }}>
                    <div className="Addproducts-container">
                        <label className="Addproducts-title">Category</label>
                        <select
                            name="category"
                    ...
                    <div className="Addproducts-container">
                        <label className="Addproducts-title">Name</label>
                        <input
                            className="Addproducts-text"
                            type="text"
                            name="name"
                            value={formData.name}
                    ...
                    {formData.category && types[formData.category] && types[formData.category].length > 0 && (
                        <div className="Addproducts-container">
                            <label className="Addproducts-title">Type</label>
                            <select
                                name="type"
                                value={formData.type}
                    ...
                    <div className="Addproducts-container">
                        <label className="Addproducts-title">Product By</label>
                        <input
                            className="Addproducts-text"
                            type="text"
                            name="productBy"
                    ...
                    <div className="Addproducts-container">
                        <label className="Addproducts-title">Quantity</label>
                        <input
                            className="Addproducts-text"
                            type="number"
                            name="quantity"
                    ...
                    <div className="Addproducts-container">
                        <label className="Addproducts-title">Height</label>
                        <input
                            className="Addproducts-text"
                            type="text"
                            name="height"
                    ...
                    <div className="Addproducts-container">
                        <label className="Addproducts-title">Width</label>
                        <input
                            className="Addproducts-text"
                            type="text"
                            name="width"
                    ...
                    <div className="Addproducts-container">
                        <label className="Addproducts-title">Length</label>
                        <input
                            className="Addproducts-text"
                            type="text"
                            name="length"
                    ...
                    {formData.category && sizes[formData.category] && sizes[formData.category].length > 0 && (
                        <div className="Addproducts-container">
                            <label className="Addproducts-title">Sizes</label>
                            {formData.sizes.map((size, index) => (
                                <div key={index}>
                                    ...
                                    />
                                    <br />
                                    <button className="Addproducts-button2" type="button" onClick={() => handleRemoveItem('sizes', index)}>
                                        <FontAwesomeIcon icon={faMinus} />
                                    </button>
                                </div>
                            ))}
                            <button type="button" className="Addproducts-button1" onClick={() => handleAddItem('sizes')}>
                ...
                <div style={{ flex: 1, marginRight: '50px' }}>
                    <div style={{ flex: 1 }}>
                        <div className="Addproducts-container">
                            <label className="Addproducts-title">Gold Types</label>
                            {formData.goldType.map((type, index) => (
                                <div key={index}>
                                    ...
                                    />
                                    <br />
                                    <button type="button" className="Addproducts-button2" onClick={() => handleRemoveItem('goldType', index)}>
                                        <FontAwesomeIcon icon={faMinus} />
                                    </button>
                                </div>
                            ))}
                            <button type="button" className="Addproducts-button1" onClick={() => handleAddItem('goldType')}>
                                <FontAwesomeIcon icon={faPlus} />
                            </button>
                        </div>
                    </div>
                    <div className="Addproducts-container">
                        <label className="Addproducts-title">Gold Karats</label>
                        {formData.goldKt.map((kt, index) => (
                            <div key={index}>
                                ...
                                <input
                                    ...
                                    placeholder="Price"
                                />
                                {/* Add input field for gold weight */}
                                <input
                                    className="Addproducts-text"
                                    type="text"
                                    name="goldWeight"
                                ...
                                />
                                <br />
                                <button type="button" className="Addproducts-button2" onClick={() => handleRemoveItem('goldKt', index)}>
                                    <FontAwesomeIcon icon={faMinus} />
                                </button>
                            </div>
                        ))}
                        <button type="button" className="Addproducts-button1" onClick={() => handleAddItem('goldKt')}>
                            <FontAwesomeIcon icon={faPlus} />
                        </button>
                    </div>
                </div>
                <div style={{ flex: 1 }}>
                    <div className="Addproducts-container">
                        <label className="Addproducts-title">Diamond Types</label>
                        {formData.diamondType.map((type, index) => (
                            <div key={index}>
                                ...
                                />
                                <br />
                                <button type="button" className="Addproducts-button2" onClick={() => handleRemoveItem('diamondType', index)}>
                                    <FontAwesomeIcon icon={faMinus} />
                                </button>
                            </div>
                        ))}
                        <button type="button" className="Addproducts-button1" onClick={() => handleAddItem('diamondType')}>
                            <FontAwesomeIcon icon={faPlus} />
                        </button>
                    </div>
                </div>
                <div style={{ flex: 1 }}>
                    <div className="Addproducts-container">
                        <label className="Addproducts-title">Stone Types</label>
                        {formData.stoneType.map((type, index) => (
                            <div key={index}>
                                ...
                                />
                                <br />
                                <button type="button" className="Addproducts-button2" onClick={() => handleRemoveItem('stoneType', index)}>
                                    <FontAwesomeIcon icon={faMinus} />
                                </button>
                            </div>
                        ))}
                        <button type="button" className="Addproducts-button1" onClick={() => handleAddItem('stoneType')}>
                            <FontAwesomeIcon icon={faPlus} />
                        </button>
                    </div>
                </div>
                <div style={{ flex: 1 }}>
                    <div className="Addproducts-container">
                        <label className="Addproducts-title">Making Charges</label>
                        <input
                            className="Addproducts-text"
                            type="number"
                            name="makingCharges"
                    ...
                    <div className="Addproducts-container">
                        <label className="Addproducts-title">GST</label>
                        <input
                            className="Addproducts-text"
                            type="number"
                            name="gst"
                    ...
                    <div className="Addproducts-container">
                        <label className="Addproducts-title">Offer</label>
                        <input
                            className="Addproducts-text"
                            type="number"
                            name="offer"
                    ...
                    <div className="Addproducts-container">
                        <label className="Addproducts-title">Product Pictures (Images)</label>
                        <input
                            className="Addproducts-text"
                            type="file"
                    ...
                    <div className="Addproducts-container">
                        <label className="Addproducts-title">Video Product (Video)</label>
                        <input
                            className="Addproducts-text"
                            type="file"
                            name="productVideo"
                    ...
                    <div className="Coloum">
                        {formData.productPictures.length > 0 && (
                            <div className="col-md-8">
                                <h5>Selected Images</h5>
                                {formData.productPictures.map((image, index) => (
                                    <img
                                        key={index}
                        ...
                        {formData.productVideo && (
                            <div className="col-md-3">
                                ...
                                <video controls style={{ maxWidth: "100px" }}>
                                    <source src={URL.createObjectURL(formData.productVideo)} type="video/mp4" />
                                    Your browser does not support the video tag.
                                </video>
                            </div>
                        )}
                    </div>
                    <button className='Addproducts-button' >Submit</button>
                </div>
            </form>
            <Dialog
                message={message}
